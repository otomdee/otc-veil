...
import OtcDesk from './components/client/OtcDesk/OtcDesk';
    ...
    <div className={styles.page}>
      ...
      <header className={styles.hero}>
        <h1 className={styles.heroTitle}>
          Trustless OTC,
          <br />
          <span className={styles.heroAccent}>Privately Settled</span>
        </h1>
        <p className={styles.heroSub}>
          List and fill large trades through the STRK20 privacy pool. No desk
          holds your funds, no chain observer links the counterparties.
        </p>
      </header>
